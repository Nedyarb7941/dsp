...
function uiAdjustVKLayout() {
    ...
    $id('vk-menu').style = makeVKStyle(window.innerHeight - (vkh * 0.7) - 100, window.innerWidth / 2 - vkw / 2, vkw, vkh, fontSize);
    ...
    vkMap['select'].style = makeVKStyle(offTop + abxyHeight - vkh, window.innerWidth / 2 - vkw * 2.25, vkw, vkh, fontSize);

...
function uiAdjustVKLayout() {
    ...
    vkMap['b'].style = makeVKStyle(offTop + abxyHeight / 2 - vkh * 0.425, offLeft + abxyWidth / 2 - vkw * 0.425, vkw * 0.85, vkh * 0.85, fontSize * 0.85)
    vkMap['x'].style = makeVKStyle(offTop + abxyHeight / 2 + vkh * 0.425, offLeft + abxyWidth / 2 - vkw * 0.425, vkw * 0.85, vkh * 0.85, fontSize * 0.85)
    vkMap['y'].style = makeVKStyle(offTop + abxyHeight / 2 - vkh * 0.425, offLeft + abxyWidth / 2 + vkw * 0.425, vkw * 0.85, vkh * 0.85, fontSize * 0.85)
    ...
    vkMap['select'].style = makeVKStyle(offTop + abxyHeight - vkh, window.innerWidth / 2 - vkw * 0, vkw, vkh, fontSize)
    vkMap['start'].style = makeVKStyle(offTop + abxyHeight - vkh, window.innerWidth / 2 + vkw * 0, vkw, vkh, fontSize)
}
